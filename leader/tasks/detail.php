    ...
    <main class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Trang chi tiết công việc</p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?= e(base_url('/leader/tasks/edit.php?id=' . $task['id'])) ?>" class="btn btn-warning">Sửa công việc</a>
            ...
            <div class="col-lg-5">
                <div class="card section-card">
                    <div class="card-body p-4">
                        ...
                        <p><strong>Người thực hiện:</strong> <?= e($task['member_name']) ?></p>
                        <p><strong>Người giao:</strong> <?= e($task['creator_name']) ?></p>
                        <p>
                ...
                <div class="card section-card mb-4">
                    ...
                    <div class="card-body px-4">
                        <?php if (empty($updates)): ?>
                            <p class="text-muted mb-0">Chưa có cập nhật tiến độ nào.</p>
                        <?php else: ?>
                ...
                <div class="card section-card mt-4" id="task-comments">
                    ...
                    <div class="card-body px-4">
                        <form method="POST" action="<?= e(base_url('/task_comments/store.php')) ?>" class="mb-4">
                            ...
                            <input type="hidden" name="redirect_to" value="<?= e(task_detail_url_for_role('leader', $id) . '#task-comments') ?>">
                            <label class="form-label">Thêm bình luận</label>
                            <textarea name="comment_text" rows="3" class="form-control" placeholder="Trao đổi nhanh với thành viên về công việc này" required></textarea>
                            <div class="mt-3">
